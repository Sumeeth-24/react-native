...
import {View, Text, StyleSheet,  Alert, ScrollView, Dimensions, FlatList} from 'react-native';
...
const renderListItem = (listLength,itemData) => (<View style={styles.listItem}><BodyText>#{listLength - itemData.index}</BodyText>
<BodyText>{itemData.item}</BodyText></View>);
    ...
    const nextGuessHandler = direction => {
      ...
      if (availabledeviceHeight < 400) {
          return (
            ...
            <Text style={styles.fla}>Opponent's Guess</Text>
...
const styles = StyleSheet.create({
    ...
    buttonContainer: {
        ...
        marginTop: Dimensions.get('window').height > 600 ? 25 : 10,
        width:400,
        maxWidth: '90%'
    },
    fla:{
